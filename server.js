...
CHAMBATINA MIAMI	GEO MIA		CPK-0263116	EN AGENCIA	...
CH
...
`;
function esAtrasado(cpk) {
  const texto = RAW_DELAYED_SOURCE.toUpperCase();
  return texto.includes(`CPK-${cpk}`);
}
const app = express();
...
A partir de los 6 días hábiles desde la fecha original,
