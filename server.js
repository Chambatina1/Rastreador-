...
function mapearEstadoTexto(estadoTexto = "") {
  ...
  if (
    e.includes("EN DISTRIBUCION") ||
    e.includes("EN DISTRIBUCIÓN") ||
    e === "DISTRIBUCION" ||
    e === "DISTRIBUCIÓN"
  ) {
...
function construirSaludo(embarcador = "", consignatario = "", estado = "") {
  ...
  if (nombreEmbarcador && nombreConsignatario) {
    return `Hola ${nombreEmbarcador}, tus paquetes a ${nombreConsignatario} se encuentran en: ${estado || ETAPAS.EN_PROCESO}.`;
  }

  if (nombreEmbarcador) {
    return `Hola ${nombreEmbarcador}, tus paquetes se encuentran en: ${estado || ETAPAS.EN_PROCESO}.`;
  }

  return `Hola, tu mercancía se encuentra en: ${estado || ETAPAS.EN_PROCESO}.`;
}
